...
let
  ...
  xmlfile = lib.mkIf (xfceCfg.enableXfwm)
    (pkgs.writeText "xfwm4.xml" ''
      ...
      <channel name="xfwm4" version="1.0">
        <property name="general" type="empty">
          ...
          <property name="theme" type="string" value="${cfg.theme}"/>
          <property name="tile_on_move" type="bool" value="true"/>
          <property name="title_alignment" type="string" value="center"/>
          <property name="title_font" type="string" value="${cfg.titleFont} ${toString cfg.titleSize}"/>
...
{
  options = {
    services.xserver.desktopManager.xfce.xfwm = {
      theme = lib.mkOption {
        type = types.str;
        default = "Arc-Dark";
